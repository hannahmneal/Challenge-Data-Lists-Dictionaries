    ...
    class DataChallenge
    {
        static void Main(string[] args)
        {
            /*
                ...
                - Dictionary three will be named "FavoriteThings" and will contain K: person's name, V: A list containing the values from Dictionaries one and two.

                    1. Set up dicts. 1 and 2
                    2. Set up dict. 3 and loop

            !!!!!!! After creating MovieFavorites dict and FoodFavorites dict, I tried to create FavoriteThings dict with the list nested inside. The problem with this is that the key/value from MovieFavorites and FoodFavorites cannot be accessed by FavoriteThings. To continue this way, I would have to use a custom class and helper functions; alternatively, I could refactor code to create FavoriteThings first, with MovieFavorites and FoodFavorites nested inside and looped through.
